# realm-book-example
This is a rewrite of a ["Realm tutorial"](http://www.androidhive.info/2016/05/android-working-with-realm-database-replacing-sqlite-core-data) on Android Hive. Unfortunately the tutorial is extremely outdated (uses 0.82.1 even though the version 1.1.1 is out!), the code is unstructured (Realm transactions inside a click listener inside a dialog created in a long click listener); and it also misuses Realm quite heavily: 
